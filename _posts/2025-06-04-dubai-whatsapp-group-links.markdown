---
layout: post
title:  "Dubai WhatsApp Group Links"
date:   2025-06-04 13:39:30 +0530
P1:
permalink: /dubai-whatsapp-group-links.html
category: Dubai
Tab1: All Dubai Groups
Tab2: Market Dubai Groups
Tab3: Entairtainment Dubai Groups
Tab4: Movies Dubai Groups
Tab5: Songs Dubai Groups
Tab6: Media Dubai Groups
Tab7: Chat Dubai Groups
Tab8: Crypto Dubai Groups
Tab9: Stocks Dubai Groups
Tab10: Education Dubai Groups
---
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "1" %}

           {% for Dubai in ul_Dubai %}
  <tr>
  <td>{{ Dubai.name }}</td>
    <td><a href="https://{{ Dubai.link }}" target="_blank" rel="noreferrer noopener">Join</a></td>
  </tr>
{% endfor %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "2" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "3" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "4" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "5" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "6" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "7" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "8" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "9" %}
...
<div class="w3-row" style="padding: 0px;">
  ...
  <table style="width: 100%;">
             ...
             {% assign ul_Dubai = site.data.Dubai | where: "type", "10" %}
