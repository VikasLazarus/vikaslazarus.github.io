<div class=" w3-row w3-white w3-border-top w3-display-container anim5 w3-border-bottom w3-border-light-gray" style="background:url({{ site.baaseurl }}/assets/images/tex.png); margin-top:0px; overflow: hidden;  
">
